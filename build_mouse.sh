...
#触摸开下面这句
#-qt-mouse-linuxinput -no-mouse-tslib -no-mouse-linuxtp -no-mouse-pc -no-mouse-qvfb -no-mouse-qnx

#隐藏鼠标
#-no-mouse-tslib -qt-mouse-pc -no-mouse-linuxtp -qt-mouse-linuxinput
